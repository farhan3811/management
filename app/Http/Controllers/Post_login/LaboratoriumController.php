...
class LaboratoriumController extends Controller
{
    ...
    public function index(){
        ...
        $js_script[]  = 'vendors/EasyAutocomplete-1.3.5/jquery.easy-autocomplete.js';
        $css_script[] = 'vendors/EasyAutocomplete-1.3.5/easy-autocomplete.css';
        $css_script[] = 'vendors/EasyAutocomplete-1.3.5/easy-autocomplete.themes.css';
        ...
        return view('post-login-views.laboratorium.laboratorium_view', $data);
    }
