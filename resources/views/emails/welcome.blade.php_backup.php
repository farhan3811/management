...
@section('content')
    ...
    'heading' => 'Selamat Anda Sudah Berhasil Mendaftar Di Klinik KMU!',
    'level' => 'h1'
  ])

    @include('beautymail::templates.ark.contentStart')

        <h4 class="secondary"><strong>Hai () Kamu Sudah Berhasil Mendaftar</strong></h4>
        <p></p>

    @include('beautymail::templates.ark.contentEnd')

    @include('beautymail::templates.ark.heading', [
    'heading' => 'Anda Sudah Berhasil Mendaftar, Selanjutnya Anda Datang Ke Klinik KMU Untuk Aktivasi Akun Rekam Medis Anda.',
    'level' => 'h2'
  ])

    @include('beautymail::templates.ark.contentStart')

        <h4 class="secondary"><strong>Info : customers@klinikmatautamatangsel.com</strong></h4>
        <p>Telp : 021 123 456</p>
