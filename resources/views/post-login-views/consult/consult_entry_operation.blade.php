                                ...
                                <!-- <div class="form-group form-float">
                                    ...
                                    <select {{ $disabled }} id="docter_code_of_operation" name ="docter_code_of_operation" style="background-color:#45c3d8" required class="form-control show-tick" data-live-search="true" style="background-color:aliceblue;color:white" required>
                                        ...
                                        {{-- @foreach($dokter as $data) --}}
                                            <input type="hidden" id="docter_code_of_operation" value="{{ auth()->user()->docter->code_docter }}">
                                            {{-- <input type="hidden" value="{{ $data->code_docter }}"  {{ isset($agree->docter_code_of_operation)? ($data->code_docter == $agree->docter_code_of_operation)? ' selected ' : '' : '' }} >{{ $data->nama_dokter }}</input> --}}
                                        {{-- @endforeach --}}
                                <!--    </select>
                                </div> -->
