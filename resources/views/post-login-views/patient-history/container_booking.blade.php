@foreach($booking as $data)
    <div class="body table-responsive">
        <table class="table table-hover table-condensed table-striped-new">
            <tbody>
                    <tr>
                        <td style="width:45%"><span  class="pull-right" ><b>Booking Dari</span></b></td>
                        <td>{{ $data->booking_dari }}</td>
                    </tr>
                    <tr>
                        <td style="width:45%"><span  class="pull-right" ><b>Booking Untuk Tanggal</span></b></td>
                        <td>{{ date('l, d M Y', strtotime(substr($data->booking_tanggal, 0, 10))) }}</td>
                    </tr>
                    <tr>
                        <td style="width:45%"><span  class="pull-right" ><b>Booking Untuk Poliklinik</span></b></td>
                    ...
                    <tr>
                        <td style="width:45%"><span  class="pull-right" ><b>Booking Untuk Dokter</span></b></td>
                        <td>{{ isset($data->toBookingTime->toBookingDay->toDocter->nama_dokter)? $data->toBookingTime->toBookingDay->toDocter->nama_dokter : '' }}</td>
                    </tr>
                    <tr>
                        <td style="width:45%"><span  class="pull-right" ><b>Booking Hari Jadwal Dokter</span></b></td>
                        <td>{{ isset($data->toBookingTime->toBookingDay->day)? date('l', strtotime($data->toBookingTime->toBookingDay->day)) : '' }}</td>
                    </tr>
                    <tr>
                        <td style="width:45%"><span  class="pull-right" ><b>Booking Jam Jadwal Dokter</span></b></td>
                    ...
                    <tr>
                        <td style="width:45%"><span  class="pull-right" ><b>Tanggal Booking</span></b></td>
                        <td>{{ date('l, d M Y', strtotime(substr($data->created_at, 0, 10))) }}</td>
                    </tr>
                    <tr>
                        <td style="width:45%"><span  class="pull-right" ><b>Waktu Booking</span></b></td>
    ...
    <div class="" style="padding-top:10px;padding-left:20px">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border:solid 1px #d7d7d7;background-color:#d5ffe1;padding:5px">
