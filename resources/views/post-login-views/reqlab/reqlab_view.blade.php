                ...
                <div class="card">
                    <div class="header">
                        <div class="row clearfix">
                            <div class="col-xs-12 col-sm-4">
                                <h2 style="float:left;padding-right:15px"><b>ANTRIAN LABORATORIUM</b></h2>
                    ...
                    <div class="body">
                        <div class="table-responsive" style="overflow-x: visible; ">
                            <table class="table table-hover js-exportable-ajax" data-original-tb="queue-lab" selected-row="1" width="100%" style="width:100%">
                                <thead>
                                    <tr>
                                        <th style=""></th>
