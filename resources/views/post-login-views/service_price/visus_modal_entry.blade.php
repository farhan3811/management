    ...
    <div class="row clearfix">
        ...
        <div class="col-sm-12" style="padding-top:20px">
            <div class="col-sm-12">
                <div class="form-group form-float">
                    <div class="form-line">
                        <textarea rows="1" {{ $disabled }}  id="keterangan_data" class="form-visus form-control no-resize auto-growth" style="overflow: hidden; overflow-wrap: break-word; height: 32px;">{{ isset($result->keterangan)? $result->keterangan : '' }}</textarea>
        ...
        <div class="col-sm-12" style="padding-top:20px">
            <div class="col-sm-12">
                <div class="form-group form-float">
                    <div class="form-line">
                        <textarea rows="1" {{ $disabled }}  id="saran_data" class="form-visus form-control no-resize auto-growth" style="overflow: hidden; overflow-wrap: break-word; height: 32px;">{{ isset($result->saran)? $result->saran : '' }}</textarea>
        ...
        <div class="col-sm-12" style="padding-top:20px">
            ...
            <div class="col-sm-4 ">
                <div style="padding-left:30px">
                    ...
                    <label for="tagihan" id="tagihan-label" style="color:black">Masukkan ke tagihan</label>
                </div>
            </div>
            <div class="col-sm-4">
                <div>
...
<script>
    $(function () {
        ...
        $("#tagihan-label").popover({
            ...
            content: function () {
                $.ajax({
                    url: $('.mainurl').val() +'/getListPrice/Visus/'+$('#queue').val(),
                    type: "get",
                    cache: false,
                    async: false,
