...
<div id="entry-obat">
        ...
        <div class="col-sm-12" style="padding:15px;border:5px solid !important;background-color:#EDF1FF !important">
            ...
            @foreach($allmed as $data)
                ...
                <div class="col-sm-6">
                    ...
                    <label for="md_checkbox_{{$data->id}}" style="color:black">{{ $data->nama_obat}} <span style="color:#ffa928">({{ isset($data->stock)? $data->stock : 0}}{{ ' '.$data->satuan }})</span></label>
    ...
    <div class="col-sm-12" style="padding-left:30px;padding-right:30px"><hr style="border-color:#80b7ff" /></div>
