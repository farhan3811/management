...
//* GET DOCTER AND THEY SCHEDULE
Route::get('docters', 'Api\ApiDocterController@getDocter');
Route::get('docters/schedule', 'Api\ApiDocterController@getSchedule');
...
Route::group(['middleware' => ['auth', 'role:pemeriksa|docter|main_docter|admin|laborant|surgeon']], function () {
...
Route::group(['middleware' => ['auth', 'role:docter|main_docter|admin']], function () {
...
Route::group(['middleware' => ['auth', 'role:admin|laborant']], function () {
...
Route::group(['middleware' => ['auth', 'role:surgeon|admin']], function () {
...
Route::group(['middleware' => ['auth', 'role:cashier|admin|main_docter|docter']], function () {

    Route::get('report/rekam_medis', 
        'Post_login\ReportsController@medical_reports')->name('reports.medical_records');

    Route::get('report/export/pdf/{medical_record}', 
        'Others\ContainerPatientController@export_pdf')->name('container_patient.export_pdf');
...
Route::group(['middleware' => ['auth', 'role:admin|docter|main_docter|pemeriksa|surgeon']], function () {
